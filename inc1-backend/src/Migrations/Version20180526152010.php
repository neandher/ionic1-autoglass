 ...
 */
final class Version20180526152010 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pergunta (id INT AUTO_INCREMENT NOT NULL, questionario_id INT DEFAULT NULL, resposta_id INT DEFAULT NULL, descricao VARCHAR(255) NOT NULL, pontuacao INT NOT NULL, dica VARCHAR(255) NOT NULL, respondida TINYINT(1) NOT NULL, acertou TINYINT(1) NOT NULL, INDEX IDX_124A7194664E1225 (questionario_id), INDEX IDX_124A719479F97242 (resposta_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE questionario (id INT AUTO_INCREMENT NOT NULL, descricao VARCHAR(255) NOT NULL, pontuacao_total INT NOT NULL, dica_acionada TINYINT(1) NOT NULL, eliminar_acionado TINYINT(1) NOT NULL, pular_acionado TINYINT(1) NOT NULL, desafio_acionado TINYINT(1) NOT NULL, tempo INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tentativa (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tempo_inicio DATETIME NOT NULL, tempo_fim DATETIME DEFAULT NULL, INDEX IDX_DCAE46E0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
